...
import 'package:foradacaixab/design_system/button/text_button_fc.dart';
import 'package:foradacaixab/design_system/text/text_form_field_fc.dart';
          ...
          if (_formKey.currentState!.validate()) {
            ...
            if (validDocumentID) {
              ...
              if (user.id == 0) {
                ...
                //TODO: request location permission (does not work on automated test)
